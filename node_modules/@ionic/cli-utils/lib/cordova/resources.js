...
function getSourceImages(buildPlatforms, resourceTypes, resourceDir) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const sourceImages = array_1.flattenArray(srcImageDirContentList.map((srcImageDirContents, index) => (srcImageDirContents
            .map((imgName) => {
        ...
        const sourceImageChecksums = yield Promise.all(sourceImages.map((img) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const [md5, cachedMd5] = yield Promise.all([
                fs_1.getFileChecksum(img.path),
                (() => tslib_1.__awaiter(this, void 0, void 0, function* () {
                    try {
                        const md5 = yield fs_1.fsReadFile(cachedMd5Path, { encoding: 'utf8' });
                        return md5.trim();
                    }
                    catch (e) {
                        if (e.code !== 'ENOENT') {
            ...
            yield fs_1.fsWriteFile(cachedMd5Path, md5, { encoding: 'utf8' });
            return md5;
        })));
...
function uploadSourceImages(srcImages) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        return Promise.all(srcImages.map((srcImage) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const res = yield http_1.createRequest('POST', UPLOAD_URL)
                .type('form')
...
function transformResourceImage(imageResource) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            const req = http_1.createRequest('POST', TRANSFORM_URL)
                .type('form')
                .send({
...
function ensureDefaultResources(env) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (recreateTmpDir) {
            ...
            yield tarXvfFromUrl(DEFAULT_RESOURCES_URL, tmpResourcesDir, { progress: (loaded, total) => {
            ...
            for (let img of pngImages) {
                const md5 = yield fs_1.getFileChecksum(img);
                yield fs_1.fsWriteFile(`${img}.md5`, md5, { encoding: 'utf8' });
            }
            env.tasks.end();
        }
