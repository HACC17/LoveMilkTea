...
function updateIonicComponentsUsed(context, originalDependencyMap, purgedModules) {
    var includedModuleSet = new Set();
    originalDependencyMap.forEach(function (set, modulePath) {
