    ...
    classDeclarations.forEach(function (classDeclaration) {
        if (classDeclaration && classDeclaration.decorators) {
            classDeclaration.decorators.forEach(function (decorator) {
                if (decorator.expression && decorator.expression.expression && decorator.expression.expression.text === NG_MODULE_DECORATOR_TEXT) {
...
var NG_MODULE_DECORATOR_TEXT = 'NgModule';
