...
function getIonicOptimizationEnvironmentPlugin() {
    var context = helpers_1.getContext();
    return new ionic_environment_plugin_1.IonicEnvironmentPlugin(context, false);
}
exports.getIonicOptimizationEnvironmentPlugin = getIonicOptimizationEnvironmentPlugin;
